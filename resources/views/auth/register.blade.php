<x-layouts.guest>
    <div class="text-center mb-8">
        <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Registrarse</h1>
        <p class="text-sm text-slate-500 mt-2">Crea tu cuenta de MultiTasking</p>
    </div>
    ...
    <form method="POST" action="/register" class="space-y-6">
        ...
        <div>
            ...
            <input id="name" class="block w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 placeholder:text-slate-400" type="text" name="name" :value="old('name')" required autofocus placeholder="Tu nombre" />
        </div>
        ...
        <div>
            ...
            <input id="password_confirmation" class="block w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 transition-colors focus:border-primary focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 placeholder:text-slate-400" type="password" name="password_confirmation" required placeholder="••••••••" />
        </div>
        ...
        <div class="text-center mt-6">
            <a href="/login" class="text-sm font-medium text-slate-500 hover:text-primary transition-colors">
